import {Box, Button, Dialog, DialogContent, DialogContentText, DialogTitle, Divider, IconButton} from "@mui/material";
...
export const SessionCreatedDialog = (props: SessionCreatedDialogProps) => {
    ...
    return (
        ...
        <Dialog open={props.open} onClose={props.onClose} fullWidth={true} maxWidth={"sm"} sx={{
            ...
            <DialogTitle align={"center"} sx={{paddingBottom: 2}} color={"secondary"}>SESSION CREATED</DialogTitle>
            ...
            <DialogContent>
                <Box textAlign={"center"}>
                    ...
                    <DialogContentText color={"secondary"} fontSize={"small"} paddingBottom={1}>
                        {exampleSessionID}
                    </DialogContentText>
                    <Button
                        fullWidth={true}
                    ...
                    >Copy ID</Button>
                    <Divider variant="middle" flexItem>
                        <DialogContentText color={"secondary"} fontWeight={"bold"}
                                           fontSize={"larger"} paddingTop={3}
                                           paddingBottom={2}>
                            OR
                        </DialogContentText>
                    </Divider>
